<template>
    <div class="p-3 mb-2 text-white" style="background-color: white;"></div>
    <div class="make_p">
...
export default {
    ...
    methods: {
        ...
        process_result: function (){
            let rta = localStorage.getItem("Result");
            console.log(typeof(rta));
            if (rta=='false') {
                return "Congratulations, you're unlikely to have Diabetes"
            }else{
                return "You may have Diabetes, you should go for a medical checkup"
            }
        }
    }
}
